...
I’ve not received a bug report in the past three years; however, I discovered a couple that still need to be addressed.

I compared the dissection latency between the original and updated TCP dissector and found little difference. If requested, I can perform an ANOVA to statistically substantiate this finding.
